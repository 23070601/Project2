...
const TASK_STATUS_FLOW = {
  [TASK_STATUS.ASSIGNED]: [TASK_STATUS.RECEIVED, TASK_STATUS.IN_PROGRESS, TASK_STATUS.COMPLETED],
  [TASK_STATUS.RECEIVED]: [TASK_STATUS.IN_PROGRESS, TASK_STATUS.COMPLETED],
  [TASK_STATUS.IN_PROGRESS]: [TASK_STATUS.COMPLETED, TASK_STATUS.RECEIVED],
  [TASK_STATUS.COMPLETED]: [TASK_STATUS.CLOSED, TASK_STATUS.IN_PROGRESS],
  [TASK_STATUS.CLOSED]: [],
};
